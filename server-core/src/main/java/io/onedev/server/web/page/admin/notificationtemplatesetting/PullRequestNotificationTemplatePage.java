...
public class PullRequestNotificationTemplatePage extends AdministrationPage {
	...
	protected void onInitialize() {
		...
		variableHelp.put("pullRequest", " represents the <a href='https://code.onedev.io/projects/160/blob/main/server-core/src/main/java/io/onedev/server/model/PullRequest.java' target='_blank'>pull request</a> object to be notified");
